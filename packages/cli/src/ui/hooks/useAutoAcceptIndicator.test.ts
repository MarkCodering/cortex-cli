...
import type { Config as ActualConfigType } from '@markcodering/cortex-cli-core';
import { Config, ApprovalMode } from '@markcodering/cortex-cli-core';
